...
function init-variables {
    ...
    RHYTHM_URL="http://18.205.30.160:2022/rhythm/v1"
    OFFICE_URL="http://18.205.30.160:2023/office/v1"
    CUSTOMER_URL="http://18.205.30.160:2024/customer/v1"
    ACCOUNTING_URL="http://18.205.30.160:2025/accounting/v1"
    PORTFOLIO_URL="http://18.205.30.160:2026/portfolio/v1"
    DEPOSIT_URL="http://18.205.30.160:2027/deposit/v1"
    TELLER_URL="http://18.205.30.160:2028/teller/v1"
    REPORT_URL="http://18.205.30.160s:2029/report/v1"
    CHEQUES_URL="http://18.205.30.160:2030/cheques/v1"
    PAYROLL_URL="http://18.205.30.160s:2031/payroll/v1"
    GROUP_URL="http://18.205.30.160:2032/group/v1"
    NOTIFICATIONS_URL="http://18.205.30.160:2033/notification/v1"
