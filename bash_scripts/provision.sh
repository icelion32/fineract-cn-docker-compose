...
function init-variables {
    ...
    PROVISIONER_URL="http://localhost:2020/provisioner/v1"
    IDENTITY_URL="http://localhost:2021/identity/v1"
    RHYTHM_URL="http://localhost:2022/rhythm/v1"
    OFFICE_URL="http://localhost:2023/office/v1"
    CUSTOMER_URL="http://localhost:2024/customer/v1"
    ACCOUNTING_URL="http://localhost:2025/accounting/v1"
    PORTFOLIO_URL="http://localhost:2026/portfolio/v1"
    DEPOSIT_URL="http://localhost:2027/deposit/v1"
    TELLER_URL="http://localhost:2028/teller/v1"
    REPORT_URL="http://localhosts:2029/report/v1"
    CHEQUES_URL="http://localhost:2030/cheques/v1"
    PAYROLL_URL="http://localhosts:2031/payroll/v1"
    GROUP_URL="http://localhost:2032/group/v1"
    NOTIFICATIONS_URL="http://localhost:2033/notification/v1"
